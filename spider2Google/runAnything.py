a = """public static final String ACCEPT_HANDOVER = "android.permission.ACCEPT_HANDOVER";
...
for i in a:
    if i.__contains__('public static final String '):
        permission_name = i.split('=')[1].split(';')[0]
        print('<uses-permission android:name=%s\ntools:ignore="ProtectedPermissions" />'%permission_name)
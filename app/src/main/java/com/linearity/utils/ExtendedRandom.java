...
//        int exactLength = nextInt(length - minLength) + minLength + 1;
    ...
    public Object pickFromArray(Object[] array){
...
//        XposedHelpers.setObjectField(toConfuse,"dataDir", getRandomString(nextInt(10)+5));
//        XposedHelpers.setObjectField(toConfuse,"deviceProtectedDataDir", getRandomString(nextInt(10)+5));
//        XposedHelpers.setObjectField(toConfuse,"credentialProtectedDataDir", getRandomString(nextInt(10)+5));

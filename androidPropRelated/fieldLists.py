...
banned_field_list = [
    "ro.lineage.build.version", "ro.lineage.build.version.plat.rev",
    "ro.lineage.build.version.plat.sdk",
    "ro.lineage.device", "ro.lineage.display.version", "ro.lineage.releasetype",
    "ro.lineage.version", "ro.lineagelegal.url","ro.modversion"
]
incremental_list = [
